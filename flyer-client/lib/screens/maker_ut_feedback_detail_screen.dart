...
class MakerUTFeedbackDetailScreen extends StatefulWidget {
  const MakerUTFeedbackDetailScreen({
    super.key,
    required this.utCase,
  });

  final MakerUTCase utCase;

  @override
  State<MakerUTFeedbackDetailScreen> createState() =>
      _MakerUTFeedbackDetailScreenState();
}

class _MakerUTFeedbackDetailScreenState
    extends State<MakerUTFeedbackDetailScreen> {
