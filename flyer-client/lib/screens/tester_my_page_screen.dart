...
import 'package:flyer_client/screens/tester_update_my_profile_screen.dart';
import 'package:flyer_client/screens/entry_screen.dart';
import 'package:flyer_client/screens/maker_tab_screen.dart';
import 'package:flyer_client/screens/register_corporate_maker_screen.dart';
import 'package:flyer_client/screens/register_individual_maker_screen.dart';
import 'package:flyer_client/util/app_version.dart';
import 'package:flyer_client/util/colors.dart';
import 'package:url_launcher/url_launcher.dart';

class TesterMyPageScreen extends StatefulWidget {
  const TesterMyPageScreen({super.key});

  @override
  State<TesterMyPageScreen> createState() => _TesterMyPageScreenState();
}

class _TesterMyPageScreenState extends State<TesterMyPageScreen> {
  Future<Response> myInfoFuture = queryMyInfo();
  Future<String> userModeFuture = getUserMode();
                              ...
                              FutureBuilder(
                                ...
                                builder: (context, snapshot) {
                                  if (snapshot.connectionState ==
                                    ...
                                    if (myInfo.user.userType != "TESTER") {
                                      // 메이커로 전환 토글 버튼
                                      return Padding(
                                        padding: const EdgeInsets.symmetric(
                                            vertical: 3.0),
